...
class GuestListCommands extends UpdatingControlPanel<banterpb.Config> {
    private _button: HTMLButtonElement;
    private _table: HTMLTableElement;
    private _edit: GuestListCommandEdit;

    constructor(cfg: Cfg) {
        super({ title: 'Guest List Commands', help, data: cfg });
...
`;
        ...
        this._edit = new GuestListCommandEdit(cfg);
    ...
    private _newCmd() {
        ...
        if (this.last.guestListCommands[name]) {
